...
1.  What's gone wrong with this code? Why are the points not blue?
    ...
    Answer: It mapps aesthetic to the variables, but if mapping a single color will not properly illustrate what the scatter spots mean. If want all the color to be blue, do not need to add another dimension to aes, only need to add color attributes: ggplot(data = mpg) + geom_point(mapping = aes(x = displ, y = hwy), color = "blue").
